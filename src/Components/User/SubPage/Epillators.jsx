...
const Epillators = () => {
  ...
  const handleProductClick = async (product) => {
    ...
    try {
      ...
      await set(logRef, {
        ...
        category: "Epillators", // ✅ static or dynamic
  ...
  return (
    <div style={styles.container}>
      ...
      <h2 style={styles.heading}>Buy Epillators Online</h2>

      {/* Search */}
      <div style={styles.searchContainer}>
        <input
          type="text"
          placeholder="Search for a Epillators..."
          value={searchTerm}
              ...
              >
                <div style={styles.card}>
                  <img
                    ...
                    alt={product.Heading || "Epillators"}
...
const styles = {
  ...
  cardTitle: { margin: 0, fontWeight: "bold", color: "#333", fontSize: "16px" },
};

export default Epillators;
