...
const products = [
  {
    ...
    image: Soap1,
    link: "https://amzn.in/d/eRG0aj5", // Replace with real product link
  },
    ...
    <div style={styles.container}>
      ...
      <div style={styles.bannerContainer}>
        ...
        <div style={styles.bannerText}>
          Gentle, Fresh & Clean <br /> Discover the Best Soaps for Every Skin Type
        </div>
      </div>
      ...
      <div className="product-grid">
        {productsToShow.length > 0 ? (
          ...
          <p style={{ textAlign: "center", width: "100%", color: "#666" }}>
            No soaps found matching "{searchTerm}".
          </p>
        )}
      </div>
    </div>
