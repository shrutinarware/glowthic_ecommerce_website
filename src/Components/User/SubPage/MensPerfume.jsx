...
import PerfumeBanner from "../../../assets/FragnanceSubpage/Tperfume.jpg"; // Replace with your perfume banner image

// Men's Perfume Product Images (update paths as needed)
import Perfume1 from "../../../assets/FragnanceSubpage/PerfumeFoggMen.jpg";
...
const products = [
  {
    ...
    image: Perfume1,
    link: "https://amzn.in/d/gsCCU3q", // Replace with actual link
  },
];
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.bannerContainer}>
        <img
          src={PerfumeBanner}
          alt="Men's Perfume Banner"
          style={styles.bannerImage}
        />
        <div style={styles.bannerText}>
          Long-Lasting Fragrances <br /> Discover Top Men's Perfumes
        </div>
      </div>
