...
const CombinationSkin = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    const productsRef = ref(database, "products_combination");
  ...
  const handleProductClick = async (product) => {
    ...
    try {
      ...
      await set(logRef, {
        ...
        category: "Combination Skin", // ✅ static or dynamic
  ...
  return (
    <div style={styles.container}>
      ...
      <h2 style={styles.heading}>Buy Skincare Products for Combination Skin</h2>
              ...
              >
                <div style={styles.card}>
                  <img
                    ...
                    alt={product.Heading || "Combination Skin"}
