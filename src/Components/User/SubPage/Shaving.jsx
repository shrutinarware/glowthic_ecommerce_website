...
const products = [
  {
    name: "Gillette Classic Shaving Foam",
    image: Shaving1,
    link: "https://amzn.in/d/6RjEyY0",
  },
...
const Shaving = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <h2 style={styles.heading}>Buy Shaving Products Online</h2>

      {/* Banner */}
      <div style={styles.bannerContainer}>
        <img
          src={ShavingBanner}
          alt="Shaving Products Banner"
          style={styles.bannerImage}
        />
        <div style={styles.bannerText}>
          Smooth & Clean Shaves <br /> Explore Top Shaving Essentials
        </div>
      </div>
      ...
      <div style={styles.searchContainer}>
        <input
          type="text"
          placeholder="Search for shaving products..."
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
          style={styles.searchInput}
          aria-label="Search shaving products"
        />
      </div>
      ...
      <div className="product-grid">
        {productsToShow.length > 0 ? (
          ...
          <p style={{ textAlign: "center", width: "100%", color: "#666" }}>
            No shaving products found matching "{searchTerm}".
          </p>
        )}
      </div>
    </div>
