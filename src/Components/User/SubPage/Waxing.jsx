...
const products = [
  {
    name: "Veet Ready-to-Use Wax Strips",
    image: Wax1,
    link: "https://amzn.in/d/8l7OdxD",
  },
...
const Waxing = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <h2 style={styles.heading}>Buy Waxing Products Online</h2>
      ...
      <div style={styles.bannerContainer}>
        ...
        <div style={styles.bannerText}>
          Smooth Skin at Home <br /> Best Waxing Kits & Strips
        </div>
      </div>
      ...
      <div style={styles.searchContainer}>
        <input
          type="text"
          placeholder="Search for waxing products..."
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
          style={styles.searchInput}
          aria-label="Search waxing products"
        />
      </div>
      ...
      <div className="product-grid">
        {productsToShow.length > 0 ? (
          ...
          <p style={{ textAlign: "center", width: "100%", color: "#666" }}>
            No waxing products found matching "{searchTerm}".
          </p>
        )}
      </div>
    </div>
