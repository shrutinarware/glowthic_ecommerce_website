 ...
 const [products, setProducts] = useState([]);
  ...
  useEffect(() => {
    const storedProducts =
      JSON.parse(localStorage.getItem("products_normal")) || [];
  ...
  useEffect(() => {
    if (products.length > 0) {
      localStorage.setItem("products_normal", JSON.stringify(products));
    }
  }, [products]);
