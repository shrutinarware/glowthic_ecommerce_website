...
// Import or create a reusable ProductForm component
import ProductForm from "../AdminSubPage/ProductForm"; // Adjust path accordingly
...
const AdminBodywash = () => {
  ...
  useEffect(() => {
    const storedProducts =
      JSON.parse(localStorage.getItem("products_bodywash")) || [];
  ...
  useEffect(() => {
    if (products.length > 0) {
      localStorage.setItem("products_bodywash", JSON.stringify(products));
    }
  }, [products]);
