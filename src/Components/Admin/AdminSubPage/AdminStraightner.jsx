...
const AdminStraightener = () => {
  ...
  useEffect(() => {
    const storedProducts = JSON.parse(localStorage.getItem("products_straightener")) || [];
  ...
  useEffect(() => {
    if (products.length > 0) {
      localStorage.setItem("products_straightener", JSON.stringify(products));
    }
  }, [products]);
...
export default AdminStraightener;
