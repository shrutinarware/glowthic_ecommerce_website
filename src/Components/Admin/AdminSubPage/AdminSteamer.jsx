...
const AdminSteamer = () => {
  ...
  useEffect(() => {
    const storedProducts = JSON.parse(localStorage.getItem("products_facial_steamer")) || [];
  ...
  useEffect(() => {
    if (products.length > 0) {
      localStorage.setItem("products_facial_steamer", JSON.stringify(products));
    }
  }, [products]);
