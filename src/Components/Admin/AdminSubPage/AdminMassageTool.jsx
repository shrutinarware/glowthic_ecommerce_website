...
import ProductForm from "../AdminSubPage/ProductForm"; // Adjust path if needed

const AdminMassageTool = () => {
  ...
  useEffect(() => {
    const storedProducts = JSON.parse(localStorage.getItem("products_massage_tool")) || [];
  ...
  useEffect(() => {
    if (products.length > 0) {
      localStorage.setItem("products_massage_tool", JSON.stringify(products));
    }
  }, [products]);
...
export default AdminMassageTool;
