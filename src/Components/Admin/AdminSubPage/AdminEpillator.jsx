...
const AdminEpilator = () => {
  ...
  useEffect(() => {
    const storedProducts = JSON.parse(localStorage.getItem("products_epilator")) || [];
  ...
  useEffect(() => {
    if (products.length > 0) {
      localStorage.setItem("products_epilator", JSON.stringify(products));
    }
  }, [products]);
