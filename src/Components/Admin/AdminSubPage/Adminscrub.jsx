...
import ProductForm from "../AdminSubPage/ProductForm"; // Reuse the same form
...
const Adminscrub = () => {
  ...
  useEffect(() => {
    const storedProducts =
      JSON.parse(localStorage.getItem("products_scrub")) || [];
  ...
  useEffect(() => {
    if (products.length > 0) {
      localStorage.setItem("products_scrub", JSON.stringify(products));
    }
  }, [products]);
